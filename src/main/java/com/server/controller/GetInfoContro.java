...
import com.server.tools.IPUtil;
import com.server.tools.ImageFileIOUtil;
import com.server.tools.Pwd3DESUtil;
import com.server.tools.TimeUtil;
...
//        }
    ...
    public String TestJsp(@RequestParam("account") String account, @RequestParam("password") String password,
                          HttpServletRequest request,Model model){
        //ModelAndView mv=new ModelAndView("indexMain");
